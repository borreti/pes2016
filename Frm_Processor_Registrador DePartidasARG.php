<?php
	...
	$golsTC = $_GET['gols-time-casa-ARG'];
	$golsTF = $_GET['gols-time-fora-ARG'];
	$str_timeCasa = $_GET['info-time-casa-ARG'];
	$str_timeFora = $_GET['info-time-fora-ARG'];
	$tipoDeJogo = $_GET['tipo-jogo-ARG'];
