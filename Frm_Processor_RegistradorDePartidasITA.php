<?php
	...
	$golsTC = $_GET['gols-time-casa-ITA'];
	$golsTF = $_GET['gols-time-fora-ITA'];
	$str_timeCasa = $_GET['info-time-casa-ITA'];
	$str_timeFora = $_GET['info-time-fora-ITA'];
	...
	if ($timeCasa != $timeFora)
	{
		...
		header("location: Info_PartidaRegistrada_Sucesso");
	}
